...
echo "다음: $share/current/hooks/claude-settings.fragment.json 을 ~/.claude/settings.json 에,"
echo "      $share/current/hooks/codex-hooks.json 을 ~/.codex/hooks.json 에 병합한 뒤"
echo "      Codex 에서 그 훅을 신뢰 승인하고 omhc status"
